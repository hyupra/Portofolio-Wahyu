...
// Assets
import Programmer from "../../assets/images/profile/aboutme.png";
      ...
      <div className="w-full flex flex-col lg:flex-row justify-start mt-10 xl:mt-24">
        <div className="w-full lg:w-1/4 flex">
          <motion.div
            ...
            className="w-1/4 lg:w-full aspect-square h-fit rounded-md dark:grayscale"
            style={{
        ...
        >
          ...
          <div className="flex flex-col gap-2 mt-10 lg:mt-0">
            <p className="dark:text-slate-200 text-zinc-700 transition-colors duration-500 text-sm xl:text-base indent-4 text-justify leading-loose">
              Hello! I am currently pursuing my studies at{" "}
              <span className="text-blue-500">Bandar Lampung University</span>,
              where I am enrolled in the{" "}
              <span className="text-blue-500">
                Faculty of Information Technology
              </span>
              , specifically in the{" "}
              <span className="text-blue-500">
                S1 Computer Science program.
              </span>{" "}
            </p>
            ...
            <AnimatePresence mode="popLayout">
              {state.about && (
                ...
                >
                  <p className="dark:text-slate-200 text-zinc-700 transition-colors duration-500 text-sm xl:text-base indent-4 text-justify leading-loose">
                    My academic journey has fostered a strong interest in{" "}
                    <span className="text-blue-500">
                      programming and web development
                    </span>
                    . Proficient in technologies like{" "}
                    <span className="text-blue-500">
                      React.js, Tailwind CSS, CodeIgniter, and Laravel,
                    </span>{" "}
                    I am passionate about crafting innovative solutions and
                    user-friendly interfaces.{" "}
                  </p>

                  <p className="dark:text-slate-200 text-zinc-700 transition-colors duration-500 text-sm xl:text-base indent-4 text-justify leading-loose">
                    Beyond coding, I find joy in exploring the world of music, a
                    hobby that complements my creative mindset. Through hands-on
                    experiences and continuous learning, I am dedicated to
                    evolving as a tech enthusiast and contributing to the
          ...
          <div className="w-full flex flex-wrap gap-5">
            ...
            <motion.div
              ...
              onClick={() =>
                linkSocmed("https://www.instagram.com/wahyuuprygg/")
              }
              className="w-12 h-12 p-2 flex bg-slate-100 rounded-md border border-zinc-950/30"
            >
            ...
            <motion.div
              ...
              onClick={() =>
                linkSocmed("https://www.linkedin.com/in/wahyuuprygg/")
              }
              className="w-12 h-12 p-2 flex bg-slate-100 rounded-md border border-zinc-950/30"
            >
