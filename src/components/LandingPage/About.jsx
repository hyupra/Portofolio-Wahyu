            ...
            <div className='w-full flex flex-col lg:flex-row justify-start mt-10 xl:mt-24'>
                ...
                <motion.div
                    ...
                    <div className='flex flex-col gap-2 mt-10 lg:mt-0'>
                        ...
                        <p className='dark:text-slate-200 text-zinc-700 transition-colors duration-500 text-sm xl:text-base indent-4 text-justify leading-loose'>Hello! I am currently pursuing my studies at <span className='text-blue-500'>Bandar Lampung University</span>, where I am enrolled in the <span className='text-blue-500'>Faculty of Information Technology</span>, specifically in the <span className='text-blue-500'>S1 Computer Science program.</span> </p>
