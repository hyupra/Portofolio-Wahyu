...
import SocioCultural from '../../assets/images/project/image/socio-cultural.png'
                ...
                <div className='w-full h-28 relative flex justify-center '>
                    <motion.div
                        ...
                        <div
                            ...
                            style={{ backgroundImage: `url(${SocioCultural})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>

                        </div>
                        <div className='w-full flex flex-col gap-1'>
                            <p className='text-sm font-bold text-zinc-700'>Game Bahasa</p>
